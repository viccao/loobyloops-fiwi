...
//        \wp_enqueue_script('jquery_transform', \get_template_directory_uri() . '/dist/js/vendor/jquery.transform-0.9.3.min.js', array('jquery'), null, false);
    }
...
if( function_exists('acf_add_options_page') ) {
  ...
  acf_add_options_page(array('page_title' => 'Display Options', 'icon_url' =>'dashicons-admin-customizer','position' => '2'));
}
